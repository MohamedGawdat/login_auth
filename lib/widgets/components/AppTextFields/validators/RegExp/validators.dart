...
class AppValidators {
  static String? Function(String?) validateName({
    ...
    List<TextValidationRule> validatorsList = [
      ...
      const MinLength(3, ValidationErrorMsgs.NameErrorMsgLength),
    ...
    validatorsList.add(RegExpRule(
        AppRegExp.nameRegExp(), ValidationErrorMsgs.NameErrorMsgRGX));
  ...
  static String? Function(String?) validateTitlesOrLabels(
    ...
    if (isRequired) {
      validatorsList.addAll([
        const IsRequired(ValidationErrorMsgs.titlesOrLabels),
        const MinLength(1, ValidationErrorMsgs.titlesOrLabels),
        RegExpRule(
  ...
  static String? Function(String?) validateAddress() {
    return qValidator([
      const MaxLength(200, ValidationErrorMsgs.maxLengthErrorMsg),
    ]);
  }
  ...
  static String? Function(String?) validateLongMsg(
    ...
    List<TextValidationRule> validatorsList = [
      const IsRequired(ValidationErrorMsgs.briefErrorMsgLength),
